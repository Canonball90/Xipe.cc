	 ...
	 public void renderCheckBox(MatrixStack matrixStack, Boolean checked, int x, int y){
		 ...
		 if(ModuleManager.INSTANCE.getModule(Gui.class).cFont.isEnabled()) {
	        ...
	        if(ModuleManager.INSTANCE.getModule(Gui.class).theme.isMode("Test") && checked) {
	        	...
	        	DrawableHelper.fill(matrixStack, x + 2, y + 2, x + 8, y + 8,  Color.yellow.getRGB());
	        ...
	        }else if(ModuleManager.INSTANCE.getModule(Gui.class).theme.isMode("Sigma Old") && checked) {
	        	DrawableHelper.fill(matrixStack, x + 2, y + 2, x + 8, y + 8,  new Color(171, 103, 231).getRGB());
	        }
