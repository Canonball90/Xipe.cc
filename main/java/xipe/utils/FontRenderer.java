...
public class FontRenderer {
    ...
    public void drawString(MatrixStack matrixStack, String text, float x, float y, FontType fontType, int color, int color2) {
        ...
        RenderUtil.setup2DRender(false);
    ...
    private void drawer(MatrixStack matrixStack, String text, float x, float y, int color) {
        ...
        y *= 2.0F;
        RenderUtil.setup2DRender(false);
        RenderUtil.bindTexture(this.resourceLocation);
        ...
        RenderUtil.shaderColor(0xffffffff);
    }
    ...
    public void drawWithShadow(MatrixStack matrixStack, String text, float x, float y, int color, boolean mcFont) {
        if (!mcFont) {
            this.drawString(matrixStack, text, x, y - 3, FontType.SHADOW_THIN, color);
        } else {
